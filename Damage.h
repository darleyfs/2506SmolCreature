...
class Damage {
public:
    static int GetDamage(SmolCreature attacker, SmolCreature defender, Move move) {
    ...
    static int GetModifiedDamage(int baseDamage, SmolCreature attacker, SmolCreature defender, Move move) {
    ...
    static int GetRandomDamage(int modifiedDamage, SmolCreature defender) {
